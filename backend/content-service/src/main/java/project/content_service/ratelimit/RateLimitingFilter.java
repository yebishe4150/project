...
public class RateLimitingFilter extends OncePerRequestFilter {
    ...
    private List<RateLimitRule> rules() {
        return List.of(
                new RateLimitRule("upload", HttpMethod.POST, "/v1/content/images", properties.getUpload()),
                new RateLimitRule("image-generation", HttpMethod.POST, "/v1/content/image-generations/generate", properties.getImageGeneration())
        );
    }
