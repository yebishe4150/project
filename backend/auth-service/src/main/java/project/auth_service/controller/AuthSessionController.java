...
import project.auth_service.dto.logout.LogoutResponseWrapper;
...
public class AuthSessionController {
    ...
    @PostMapping("/login")
    public LoginResponseWrapper login(
    ...
    @PostMapping("/refresh")
    public RefreshResponseWrapper refresh(
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    content = @Content(
                            mediaType = MediaType.APPLICATION_JSON_VALUE,
                            schema = @Schema(implementation = LogoutResponseWrapper.class)
                    )
            )
    })
    @PostMapping("/logout")
    public LogoutResponseWrapper logout(
            @CookieValue(name = REFRESH_COOKIE, required = false) String refreshToken,
            HttpServletResponse response
    ) {
        ...
        return LogoutResponseWrapper.builder()
