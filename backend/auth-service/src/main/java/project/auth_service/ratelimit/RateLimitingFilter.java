...
public class RateLimitingFilter extends OncePerRequestFilter {
    ...
    private List<RateLimitRule> rules() {
        return List.of(
                new RateLimitRule("register", HttpMethod.POST, "/v1/auth/register", properties.getRegister()),
                new RateLimitRule("login", HttpMethod.POST, "/v1/auth/login", properties.getLogin()),
                new RateLimitRule("refresh", HttpMethod.POST, "/v1/auth/refresh", properties.getRefresh())
        );
    }
